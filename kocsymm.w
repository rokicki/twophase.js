...
for (int i=0; i<1000; i++)
   for (int j=0; j<10000; j++)
      kc.move(mvs[j]) ;
cout << "Moving 10M kc took " << duration() << endl ;
for (int i=0; i<1000; i++)
   for (int j=0; j<10000; j++)
      pc.move(mvs[j]) ;
cout << "Moving 10M pc took " << duration() << endl ;
for (int i=0; i<1000; i++)
   for (int j=0; j<10000; j++)
      cp.move(mvs[j]) ;
cout << "Moving 10M cp (move) took " << duration() << endl ;
for (int i=0; i<1000; i++)
   for (int j=0; j<10000; j++)
      cp.movepc(mvs[j]) ;
cout << "Moving 10M cp (movepc) took " << duration() << endl ;
